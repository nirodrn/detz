    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">DETZ Global</h3>
            <p className="text-gray-400">Bringing innovation and excellence across multiple domains.</p>
          </div>
          <div>
            <h4 className="text-lg font-semibold mb-4">Contact Information</h4>
            <div className="space-y-2">
              <a href="https://www.facebook.com/profile.php?id=61556828565697" 
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© 2024 DETZ Global Pvt Ltd. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
